...
var sslOptions =
  process.env.NODE_ENV === "production" || process.env.NODE_ENV === "stage"
    ...
    : {};
var connectionOptions = __assign(__assign({ name: "default" }, sslOptions), {
  type: "postgres",
      ...
      switch (_b.label) {
        case 0:
          if (!connectionManager.has(connectionOptions.name))
            return [3 /*break*/, 2];
          return [4 /*yield*/, connectionManager.get(connectionOptions.name)];
        case 1:
          _a = _b.sent();
          return [3 /*break*/, 4];
        case 2:
          return [4 /*yield*/, connectionManager.create(connectionOptions)];
        case 3:
          _a = _b.sent();
          _b.label = 4;
        case 4:
